    ...
    public partial class Encryptor : Form
    {
        ...
        private void EncryptFile(string inputFile, string outputFile, string password)
        {
            try
            {
                ...
                Console.WriteLine("File has been successfully encrypted."); // Debug output
                MessageBox.Show("File has been successfully encrypted.", "Encryption Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                Console.WriteLine("Error occurred during encryption: " + ex.Message); // Debug output
                MessageBox.Show("Error occurred during encryption: " + ex.Message, "Encryption Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void DecryptFile(string inputFile, string outputFile, string password)
        {
            try
            {
                ...
                // Display success message after decryption
                MessageBox.Show("File has been successfully decrypted.", "Decryption Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error occurred during decryption: " + ex.Message, "Decryption Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
